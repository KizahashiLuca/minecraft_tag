...
execute as @e[type=minecraft:item,nbt={OnGround:1b,Item:{id:"minecraft:conduit",tag:{display:{Name:"\"\\u00a7r地雷\"",Tag:"\"Mine\""}}}}] at @s if entity @p[distance=..2] run function mtag:system/ongame/mine_system
